...
const MESSAGES = {
  'zh-CN': {
    ...
    ai_progress_skill_strict: '[{file}] 待输出报告未通过自检，正在按技能约束重新生成...',
    ...
    ai_progress_tool_round_done: '[{file}] 工具已返回，继续分析',
    ai_progress_tools_finalize: '[{file}] 正在汇总审查结果...',
    ai_progress_still_waiting: '[{file}] 仍在等待模型响应（已 {secs}s）',
  ...
  'en-US': {
    ...
    ai_progress_skill_strict: '[{file}] Pending report failed self-check, regenerating under skill constraints...',
    ...
    ai_progress_tool_round_done: '[{file}] Tool returned, continuing analysis',
    ai_progress_tools_finalize: '[{file}] Summarizing review results...',
    ai_progress_still_waiting: '[{file}] Still waiting for the model ({secs}s)',
